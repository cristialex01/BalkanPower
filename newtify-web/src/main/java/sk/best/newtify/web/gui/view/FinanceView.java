...
import sk.best.newtify.web.gui.component.widget.LuckyNumberWidget;
...
public class FinanceView extends FlexLayout {
    ...
    private final ObjectFactory<LuckyNumberWidget> luckyNumberWidgetObjectFactory;
    ...
    public FinanceView(ArticlesApi articlesApi,
                       ...
                       ObjectFactory<LuckyNumberWidget> luckyNumberWidgetObjectFactory) {
        ...
        this.luckyNumberWidgetObjectFactory = luckyNumberWidgetObjectFactory;
    }
    ...
    private void createRightWidgetPane() {
        ...
        LuckyNumberWidget luckyNumberWidget = luckyNumberWidgetObjectFactory.getObject();
        rightWidgetContent.add(luckyNumberWidget);
    }
